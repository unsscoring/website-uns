...
namespace App\Livewire\Admin\AdminKejuaraanUpdate;
...
class AdminKejuaraanUpdateInformasi extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.admin.admin-kejuaraan-update.admin-kejuaraan-update-informasi')->layoutData(['adminKejuaraan' => 'active']);
    }
    ...
    public function updateInformasi()
    {
        ...
        $this->dispatch('swal', [
            ...
            'icon' => 'success',
            'redirect' => '/admin/kejuaraan-update/' . $this->kejuaraan->id . '/informasi',
        ]);
    }
