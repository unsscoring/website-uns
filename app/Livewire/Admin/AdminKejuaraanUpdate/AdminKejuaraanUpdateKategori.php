...
class AdminKejuaraanUpdateKategori extends Component
{
    ...
    {
        return view('livewire.admin.admin-kejuaraan-update.admin-kejuaraan-update-kategori')->layoutData(['adminKejuaraan' => 'active']);
    }
}
