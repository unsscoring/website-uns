...
class AdminKejuaraanUpdateLampiran extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.admin.admin-kejuaraan-update.admin-kejuaraan-update-lampiran')->layoutData(['adminKejuaraan' => 'active']);
    }
