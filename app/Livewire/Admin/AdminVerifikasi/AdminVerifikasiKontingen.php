...
class AdminVerifikasiKontingen extends Component
{
    ...
    {
        return view('livewire.admin.admin-verifikasi.admin-verifikasi-kontingen')->layoutData(['adminVerifikasi' => 'active']);
    }
