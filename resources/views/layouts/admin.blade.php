                    ...
                    <div>
                        ...
                        @role('manajer')
                            <ul class="flex flex-col gap-4 mb-6">
                                <!-- Menu Item Dashboard -->
                                <li>
                                    <a href="{{ url('/manajer/dashboard') }}" @click="selected = (selected === 'Calendar' ? '':'Calendar')"
                                        class="menu-item group menu-item-{{ $manajerDashboard ?? 'inactive' }}">
                                        <svg class="menu-item-icon-{{ $manajerDashboard ?? 'inactive' }}"
                                ...
                                <li>
                                    <a href="#"
                                        ...
                                        class="menu-item group menu-item-{{ $manajerKejuaraan ?? 'inactive' }}">
                                        <svg class="menu-item-icon-{{ $manajerKejuaraan ?? 'inactive' }}" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="overflow-hidden transform translate"
                                        ...
                                        <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                            ...
                                            <li>
                                                <a href="{{ url('/manajer/kejuaraan') }}" class="menu-dropdown-item group"
                                                    :class="'menu-dropdown-item-{{ $manajerKejuaraan ?? 'inactive' }}'">
                                                    Kejuaraan
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    @isset($kejuaraanSelected)
                                        ...
                                        <div class="overflow-hidden transform translate"
                                            ...
                                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                                <li>
                                                    <a href="{{ url('/manajer/pembayaran') }}" class="menu-dropdown-item group"
                        ...
                        @role('superadmin')
                            <ul class="flex flex-col gap-4 mb-6">
                                ...
                                <li>
                                    <a href="#"
                                        @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                                        class="menu-item group menu-item-{{ $superadminKejuaraan ?? 'inactive' }}">
                                    ...
                                    <div class="overflow-hidden transform translate"
                                        ...
                                        <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                            class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                                            <li>
                                                <a href="{{ url('/superadmin/kejuaraan') }}"
                                ...
                                <!-- Menu Item Manajemen Akun -->
                                <li>
                                    <a href="{{ url('/superadmin/manajemen-akun') }}"
                                        @click="selected = (selected === 'ManajemenAkun' ? '':'ManajemenAkun')"
                                        class="menu-item group menu-item-{{ $superadminManajemenAkun ?? 'inactive' }}">
                                        <svg class="menu-item-icon-{{ $superadminManajemenAkun ?? 'inactive' }}" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @role('admin')
                            <ul class="flex flex-col gap-4 mb-6">
                                <!-- Menu Item Dashboard -->
                                <li>
                                    <a href="{{ url('/admin/dashboard') }}" @click="selected = (selected === 'Calendar' ? '':'Calendar')"
                                        class="menu-item group menu-item-{{ $adminDashboard ?? ( $adminVerifikasi ?? 'inactive') }}">
                                        <svg class="menu-item-icon-{{ $adminDashboard ?? ( $adminVerifikasi ?? 'inactive') }}"
                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M5.5 3.25C4.25736 3.25 3.25 4.25736 3.25 5.5V8.99998C3.25 10.2426 4.25736 11.25 5.5 11.25H9C10.2426 11.25 11.25 10.2426 11.25 8.99998V5.5C11.25 4.25736 10.2426 3.25 9 3.25H5.5ZM4.75 5.5C4.75 5.08579 5.08579 4.75 5.5 4.75H9C9.41421 4.75 9.75 5.08579 9.75 5.5V8.99998C9.75 9.41419 9.41421 9.74998 9 9.74998H5.5C5.08579 9.74998 4.75 9.41419 4.75 8.99998V5.5ZM5.5 12.75C4.25736 12.75 3.25 13.7574 3.25 15V18.5C3.25 19.7426 4.25736 20.75 5.5 20.75H9C10.2426 20.75 11.25 19.7427 11.25 18.5V15C11.25 13.7574 10.2426 12.75 9 12.75H5.5ZM4.75 15C4.75 14.5858 5.08579 14.25 5.5 14.25H9C9.41421 14.25 9.75 14.5858 9.75 15V18.5C9.75 18.9142 9.41421 19.25 9 19.25H5.5C5.08579 19.25 4.75 18.9142 4.75 18.5V15ZM12.75 5.5C12.75 4.25736 13.7574 3.25 15 3.25H18.5C19.7426 3.25 20.75 4.25736 20.75 5.5V8.99998C20.75 10.2426 19.7426 11.25 18.5 11.25H15C13.7574 11.25 12.75 10.2426 12.75 8.99998V5.5ZM15 4.75C14.5858 4.75 14.25 5.08579 14.25 5.5V8.99998C14.25 9.41419 14.5858 9.74998 15 9.74998H18.5C18.9142 9.74998 19.25 9.41419 19.25 8.99998V5.5C19.25 5.08579 18.9142 4.75 18.5 4.75H15ZM15 12.75C13.7574 12.75 12.75 13.7574 12.75 15V18.5C12.75 19.7426 13.7574 20.75 15 20.75H18.5C19.7426 20.75 20.75 19.7427 20.75 18.5V15C20.75 13.7574 19.7426 12.75 18.5 12.75H15ZM14.25 15C14.25 14.5858 14.5858 14.25 15 14.25H18.5C18.9142 14.25 19.25 14.5858 19.25 15V18.5C19.25 18.9142 18.9142 19.25 18.5 19.25H15C14.5858 19.25 14.25 18.9142 14.25 18.5V15Z"
                                ...
                                <li>
                                    <a href="#"
                                        @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                                        class="menu-item group menu-item-{{ $adminKejuaraan ?? 'inactive' }}">
                                        <svg class="menu-item-icon-inactive" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M16.5 18.75h-9m9 0a3 3 0 0 1 3 3h-15a3 3 0 0 1 3-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 0 1-.982-3.172M9.497 14.25a7.454 7.454 0 0 0 .981-3.172M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 0 0 7.73 9.728M5.25 4.236V4.5c0 2.108.966 3.99 2.48 5.228M5.25 4.236V2.721C7.456 2.41 9.71 2.25 12 2.25c2.291 0 4.545.16 6.75.47v1.516M7.73 9.728a6.726 6.726 0 0 0 2.748 1.35m8.272-6.842V4.5c0 2.108-.966 3.99-2.48 5.228m2.48-5.492a46.32 46.32 0 0 1 2.916.52 6.003 6.003 0 0 1-5.395 4.972m0 0a6.726 6.726 0 0 1-2.749 1.35m0 0a6.772 6.772 0 0 1-3.044 0" />
                                        ...
                                        <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                            ...
                                            <li>
                                                <a href="{{ url('/admin/verifikasi') }}"
                                                    class="menu-dropdown-item group"
                                                    :class="'menu-dropdown-item-{{ $adminVerifikasi ?? 'inactive' }}'">
                                                    Verifikasi
                                                </a>
                                            </li>
                                        </ul>
