                ...
                <div class="border-b border-gray-200 dark:border-gray-800">
                    <nav
                        ...
                        <a href="{{ url('/admin/kejuaraan-update/' . $kejuaraan->id . '/informasi') }}"
                            class="tab-btn inline-flex items-center gap-2 border-b-2 px-2.5 py-2 text-sm font-medium transition-colors duration-200 ease-in-out bg-transparent text-gray-500 border-brand-500 dark:text-brand-400 dark:border-brand-400">
                        ...
                        <a href="{{ url('/admin/kejuaraan-update/' . $kejuaraan->id . '/lampiran') }}"
                        ...
                        <a href="{{ url('/admin/kejuaraan-update/' . $kejuaraan->id . '/kategori') }}"
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-5 py-4 sm:px-6 sm:py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <button wire:click="openModalTambahKategoriBulk"
                    ...
                    <button wire:click="openModalTambahKategori"
                        class="inline-flex items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-100 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.05] dark:hover:text-white transition">
                        <svg class="fill-current" width="18" height="18" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill="currentColor"
                    ...
                    <div class="max-w-full overflow-x-auto">
                        <table class="min-w-full">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                @foreach ($kejuaraanKategoris as $kejuaraanKategori)
                                    <tr>
                                        ...
                                        <td class="px-5 py-4 sm:px-6">
                                            <div class="flex items-center">
                                                <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                    {{ $kejuaraanKategori->refKategori->nama_kategori }}
                                                </p>
                                            </div>
                                        </td>
                                        <td class="px-5 py-4 sm:px-6">
                                            <div class="flex items-center">
                                                <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                    {{ $kejuaraanKategori->refKategori->refGolongan->nama }}
                                                </p>
                                            </div>
                                        </td>
                                        <td class="px-5 py-4 sm:px-6">
                                            <div class="flex items-center">
                                                <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                    {{ $kejuaraanKategori->refKategori->jenis }}
                                                </p>
                                            </div>
                                        </td>
                                        <td class="px-5 py-4 sm:px-6">
                                        ...
                                        <td class="px-5 py-4 sm:px-6">
                                            <div class="flex items-center">
                                                <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                    {{ $kejuaraanKategori->bobot }}
                                                </p>
                                            </div>
                                        </td>
                                        <td class="px-5 py-4 sm:px-6">
                                            <div class="flex items-center">
                                                <button wire:click="openModalUpdateKategori({{ $kejuaraanKategori->id }})"
                                                ...
                                                <button
                                                    wire:click="confirmDeleteKategori({{ $kejuaraanKategori->id }})"
    ...
    <div>
        @if ($isModalOpen)
            ...
            <div class="fixed inset-0 bg-black bg-opacity-30 flex items-start justify-center backdrop-blur-sm"
                ...
                <div class="bg-white mt-16 rounded-lg shadow-lg w-10/12 max-w-[1400px] mx-4 sm:mx-6">
                    <!-- Header -->
                            ...
                            <form>
                                <div class="-mx-2.5 flex flex-wrap gap-y-5">
                                    <div class="w-full px-2.5 xl:w-1/2">
                                        ...
                                        <input wire:model.defer="swp" type="number" placeholder="Masukkan swp"
                                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
                                    </div>
                                    <div class="w-full px-2.5 xl:w-1/2">
                                        <label
                                            class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            Bisa daftar lebih dari 1
                                        </label>
                                        <select wire:model="multiAtlet"
                                    ...
                                    @if ($modalStatus == 'kategori')
                                        <div class="w-full px-2.5 xl:w-1/2">
                                            <label
                                                class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                                Bobot
                                            </label>
                                            <input wire:model.defer="bobot" type="text"
                                                placeholder="Contoh : 50-60 / >70 / <50"
                                                class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
                                        </div>
                                    @endif
                                    <div class="w-full px-2.5 xl:w-1/2">
                                        ...
                                        <select wire:model="regulasisId" wire:change="loadRefKategoris"  @if ($modalStatus == 'updateKategori') disabled @endif
                                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                                            <option value="">Pilih</option>
                                            @foreach ($refRegulasis as $refRegulasi)
                                                <option value="{{ $refRegulasi->id }}">
                                                    {{ $refRegulasi->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="w-full px-2.5 xl:w-1/2">
                                        ...
                                        <select wire:model="golongansId" wire:change="loadRefKategoris" @if ($modalStatus == 'updateKategori') disabled @endif
                                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                                            <option value="">Pilih</option>
                                            @foreach ($refGolongans as $refGolongan)
                                                <option value="{{ $refGolongan->id }}">
                                                    {{ $refGolongan->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="w-full px-2.5 xl:w-1/2">
                                                ...
                                                @forelse ($refKategoris as $refKategori)
                                                    <label
                                                        ...
                                                        <input type="checkbox" wire:model.defer="bulkKategorisId"
                                                            value="{{ $refKategori['id'] }}"
                                                            class="h-4 w-4 rounded border-gray-300 text-brand-600 focus:ring-brand-500">
                                                        <span>{{ $refKategori['nama_kategori'] }} -
                                                            {{ $refKategori['golongan'] }}
                                                            ({{ $refKategori['jenis'] }})
                                                        </span>
                                                    </label>
                                                @empty
                                                    <p class="text-xs text-gray-400">Tidak ada kategori.</p>
                                                @endforelse
                                            </div>
                                        @elseif ($modalStatus == 'kategori')
                                            <select wire:model="kategorisId"
                                                class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                                                <option value="">Pilih</option>
                                                @foreach ($refKategoris as $refKategori)
                                                    <option value="{{ $refKategori['id'] }}">
                                                        {{ $refKategori['nama_kategori'] }} -
                                                        {{ $refKategori['golongan'] }}
                                                        ({{ $refKategori['jenis'] }})
                                                    </option>
                                                @endforeach
                                        ...
                                        @elseif ($modalStatus == 'updateKategori')
                                            <select wire:model="kategorisId" disabled
                                                class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                                                <option value="{{$kategorisId}}">{{$kategoriSelected->refKategori->nama_kategori}} - {{$kategoriSelected->refKategori->refGolongan->nama}} ({{$kategoriSelected->refKategori->jenis}}) 
                                                        ({{ $kategoriSelected->refRegulasi->nama}})</option>
                                            </select>
                                        @endif
                                    </div>
                                    <div class="w-full px-2.5">
                                        <button
                                            @if ($modalStatus == 'bulkKategori') wire:click.prevent="createBulkKategori" @elseif($modalStatus == 'kategori') wire:click.prevent="createKategori" @elseif($modalStatus == 'updateKategori') wire:click.prevent="updateKategori" @endif
                                            type="submit"
