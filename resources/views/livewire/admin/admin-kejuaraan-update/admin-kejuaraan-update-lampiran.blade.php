<div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <button wire:click="openModalTambahUnduhan"
                            ...
                            <div class="max-w-full overflow-x-auto">
                                <table class="min-w-full">
                                    ...
                                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                        @foreach ($kejuaraanUnduhans as $kejuaraanUnduhan)
                                            <tr>
                                                ...
                                                <td class="px-5 py-4 sm:px-6">
                                                    <div class="flex items-center">
                                                        <button
                                                            wire:click="confirmDeleteUnduhan({{ $kejuaraanUnduhan->id }})"
            ...
            <div class="space-y-6">
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <button wire:click="openModalTambahLampiran"
                                class="inline-flex items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-100 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.05] dark:hover:text-white transition">
                                <svg class="fill-current" width="18" height="18" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="currentColor"
                        ...
                        <div
                            ...
                            <div class="max-w-full overflow-x-auto">
                                <table class="min-w-full">
                                    ...
                                    <!-- table body start -->
                                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                        @foreach ($kejuaraanBerkass as $kejuaraanBerkas)
                                            <tr>
                                                <td class="px-5 py-4 sm:px-6">
                                                    <div class="flex items-center">
                                                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                ...
                                                <td class="px-5 py-4 sm:px-6">
                                                    <div class="flex items-center">
                                                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                            {{ $kejuaraanBerkas->required ? 'Wajib' : 'Tidak Wajib' }}
                                                        </p>
                                                    </div>
                                                </td>
                                                <td class="px-5 py-4 sm:px-6">
                                                ...
                                                <td class="px-5 py-4 sm:px-6">
                                                    <div class="flex items-center">
                                                        <button
                                                            wire:click="confirmDeleteBerkas({{ $kejuaraanBerkas->id }})"
                                                            class="inline-flex items-center gap-2 rounded-full border border-gray-300 bg-error px-4 py-2 text-sm font-medium text-error-700 shadow-sm hover:bg-gray-100 hover:text-danger-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-white/[0.05] dark:hover:text-white transition">
                                                            <svg class="fill-current" width="18" height="18"
                                                                viewBox="0 0 24 24"
                                                                xmlns="http://www.w3.org/2000/svg">
    ...
    <div>
        @if ($isModalOpen)
            <!-- Overlay -->
            <div class="fixed inset-0 z-1000000 bg-black bg-opacity-30 flex items-start justify-center backdrop-blur-sm"
                            ...
                            <form>
                                <div class="-mx-2.5 flex flex-wrap gap-y-5">
                                    <div class="w-full px-2.5 xl:w-1/2">
                                        ...
                                        <input wire:model.defer="no" type="number" placeholder="Masukkan no"
                                    ...
                                    <div class="w-full px-2.5 xl:w-1/2">
                                        ...
                                        <input wire:model.defer="nama" type="text" placeholder="Masukkan nama"
                                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
                                    </div>
                                    @if ($modalStatus == 'unduhan')
                                        <div class="w-full px-2.5 xl:w-1/2">
                                            <label
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-2">File
                                                Unduhan</label>
                                            <input wire:model="fileUpload" type="file"
                                            ...
                                            <div wire:loading wire:target="fileUpload"
                                                class="mt-2 text-sm text-gray-500">
                                                Mengunggah...
                                            </div>
                                        </div>
                                    @elseif($modalStatus == 'lampiran')
                                        <div class="w-full px-2.5 xl:w-1/2">
                                            <label
                                                class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                                Wajib
                                            </label>
                                            <select wire:model="required"
                                        ...
                                        <div class="w-full px-2.5 xl:w-1/2">
                                            ...
                                            <input wire:model.defer="mimes" type="text"
                                                placeholder="Contoh : pdf,docx,jpg"
                                                class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
                                        </div>
                                    @endif
                                    <div class="w-full px-2.5">
                                        <button
                                            @if ($modalStatus == 'unduhan') wire:click.prevent="createUnduhan" @elseif($modalStatus == 'lampiran') wire:click.prevent="createBerkas" @endif
                                            type="submit"
